...
<script>
	...
	function display_finActionMailing(val) {
		...
		setTimeout(
			"x_actionMailing(document.mailingForm.texteMail.value,document.mailingForm.nbMail.value,display_finActionMailing);",
			delai * 1000);
		//}
...
<form name="mailingForm" method="POST" action="Actions/AMailing.php">
	<input type=button value="init Mailing" name="buttonInit" onclick="this.value='en Cours';initMailing(display_finAction)"
	/>
		...
		<table width="100%">
			<tr>
				<td width=50% style="vertical-align: top">
					<textarea rows="20" cols="80" name="texteMail"><?=file_get_contents("html/texteBAV.html");?></textarea>
				</td>
				<td width=1%>
