...
Recherche générique : <input size=30 id='obj_search' onkeyup="searchColonne('obj_search')"  placeholder="description, modèle, marque, couleur, prix depôt et prix de vente" />
...
<table width="100%" >
	<tr>
		...
		<td class="tittab onMobile" width=5%>
		<span id='obj_etat' onclick="triColonne('obj_etat')" class="sortable">Etat&nbsp;&nbsp;</span>
		</td>
		<td class="tittab maskMobile" width=10%>
