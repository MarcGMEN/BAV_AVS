<script>
	...
	function tree(val, parent, niv) {
		...
		for (var index in val) {
			...
			if (val[index] instanceof Object) {
				...
				repr += "<div class='row'>";
				repr += "<div class='col-xs-1 col-sm-1 col-md-1' ><input type='date' id='debut" + idHtml + "' onchange=\"redessin('" + idHtml + "')\"/></div>";
				repr += "<div class='col-xs-10 col-sm-10 col-md-10' ></div>";
				repr += "<div class='col-xs-1 col-sm-1 col-md-1' ><input type='date' id='fin" + idHtml + "'  onchange=\"redessin('" + idHtml + "')\"/></div>";
				repr += "</div>";
				repr += "<div class='row'>";
	...
	function initDate(id) {
		...
		debutHTML.value=start.toISOString().split('T')[0];
	...
	function dessin(id, hour) {
		...
		start=new Date(debutHTML.value);
		fin=new Date(finHTML.value);
