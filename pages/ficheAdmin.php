...
<form name="ficheForm" method="POST" onsubmit="return submitForm()" action="">
	...
	<fieldset class=fiche>
		...
		<h4>
			<div class="row tittab" id='trTitreFiche'
				...
				<div class="col-sm-8 col-md-8 col-xs-8"
					...
					<div class="col-sm-8 col-md-8 col-xs-8">
						<span style="font-size:0.6em; text-align: left;">
							Etiquette
							<span><select name=obj_modif_data style="width:80px"
									onchange="setStartSaisie(true);">
									<option value=0>A jour</option>
									<option value=1>Nouvelle</option>
									<option value=2>Modifié</option>
								</select></span>
							&nbsp;Etiquette accessoire
							<select name=obj_modif_accessoire style="width:80px"
								onchange="setStartSaisie(true);">
								<option value=0>A jour</option>
								<option value=1>Nouvelle</option>
								<option value=2>Modifié</option>
							</select>&nbsp;Coupon dépôt
							<select name=obj_modif_vendeur style="width:80px"
								onchange="setStartSaisie(true);">
								<option value=0>A jour</option>
								<option value=1>Nouvelle</option>
								<option value=2>Modifié</option>
							...
							&nbsp;Coupon sortie
							<span><select name=obj_modif_stock
									style="width:80px"
									onchange="setStartSaisie(true);">
									<option value=0>A jour</option>
				...
				<div class="col-sm-4 col-md-4 col-xs-4 tabl1">
					...
					<input type=button
						onclick="goTo('saisieExpress.php', '',document.ficheForm.obj_numero.value,null);"
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span class="titrow col-md-3 col-sm-3 col-xs-3"
					width=20%>Type</span>
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span class="titrow  col-md-3 col-sm-3 col-xs-3">Marque <span
						title="Obligatoire">*</span>

				</span>

				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=text list="listMarques"
						name="obj_marque_<?= $idRamdom ?>" size=30
						maxlength="50" tabindex=<?= $tabindex++ ?>
						style="text-transform:uppercase"
						placeholder="Marque du vélo"
						onkeyup="setStartSaisie(true);"
						onblur="x_return_list_modeles(this.value,display_list_modeles)"
						required />
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span
					class="titrow  col-md-3 col-sm-3 col-xs-3">Mod&egrave;le</span>
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=text name="obj_modele" size=25 maxlength="30"
						tabindex=<?= $tabindex++ ?>
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span class="titrow  col-md-3 col-sm-3 col-xs-3">Couleur <span
						title="Obligatoire">*</span></span>
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=text name="obj_couleur" size=20 maxlength="30"
						tabindex=<?= $tabindex++ ?>
						style="text-transform:uppercase"
						placeholder="Couleurs dominantes"
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span class="titrow  col-md-3 col-sm-3 col-xs-3">Date achat
					<span class="help link"
						onmouseover="Aff_layer('aide_date_achat')"
						onmouseout="Cache_layer('aide_date_achat')">?</span>
					<br />
				</span>
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=date name="obj_date_achat"
						tabindex=<?= $tabindex++ ?> placeholder="Date achat"
						onkeyup="setStartSaisie(true);" />
				</span>
				<span class="col-md-12 col-sm-12 col-xs-12 ">
					<div id="aide_date_achat" style="visibility: hidden;"
						class='help'>
						<small>Saisisez 01/01/AAAA si vous ne connaissez pas la
							date exacte.</small>
					</div>
				</span>
			</div>
			<!-- prix achat -->
			<div class="col-sm-4 col-md-4 col-xs-12">
				<span class="titrow  col-md-3 col-sm-3 col-xs-3">Prix
					achat</span>
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=number name="obj_prix_achat" size=5
						maxlength="10" tabindex=<?= $tabindex++ ?>
						onkeyup="setStartSaisie(true);" step="0.1" min="0"
						title="Prix d'achat de votre vélo"
						placeholder="00.00" />&#8364;
				</span>
			</div>
			<!-- Taille -->
			<div class="col-sm-4 col-md-4 col-xs-12">
				...
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=text name="obj_taille" size=25 maxlength="30"
						tabindex=<?= $tabindex++ ?>
						style="text-transform:uppercase" list="listTailles"
						placeholder="Taille du vélo"
						onkeyup="setStartSaisie(true);" />
		...
		<div class="row">
			<div class="col-sm-6 col-xs-12">
				...
				<span class="titrow col-md-2 col-sm-2 col-xs-3">Description
					...
					<span class="help link"
						onmouseover="Aff_layer('aide_descript')"
						onmouseout="Cache_layer('aide_descript')">?</span>
					<br />
				</span>
				<span class="tabInput col-md-10 col-sm-10 col-xs-9">
					<textarea rows="4" cols="100" tabindex=<?= $tabindex++ ?>
						...
						name="obj_description" maxlength="250"
						onkeyup="MaxLengthTextarea(this, 250);setStartSaisie(true)"
						placeholder="Accessoires, révision (transmission, pneus, freins..)"></textarea>
				</span>
				<span class="col-md-12 col-sm-12 col-xs-12" id='id_descplus'
					style="visibility: hidden;">
					<div style='color:blue; background-color: yellow;'
						class=' help'>Pour saisir une description plus précise
						qui accompagnera votre vélo,
						<span class="link" onclick="action_descript_plus()">
							cliquez ici.</span>
					</div>
				</span>
				<span class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-sm-6 col-xs-12" style="vertical-align: bottom;">
				...
				<div class="tabInput col-md-4 col-sm-4 col-xs-9">
					<input type=number name="obj_prix_depot" size=5
						maxlength="10" tabindex=<?= $tabindex++ ?>
						onkeyup="setStartSaisie(true);" step="0.1" min="0"
				...
				<!-- PRIX vente -->
				<div class="titrow col-md-2 col-sm-2  col-xs-3">Prix de vente:
				</div>
				<div class="tabl1 col-md-4 col-sm-4 col-xs-9">
					<input type=number name="obj_prix_vente" size=5
						maxlength="10" tabindex=<?= $tabindex++ ?>
	...
	<div class="row">
		<div class="col-sm-6 col-xs-12">
			<fieldset class=fiche>
				<legend class="titreFiche link" id='legendVendeur' <? if ($GET_modePage != "create") { ?>
				...
				<div class="row">
					<div class="col-sm-6 col-md-6 col-xs-12">
						<span class="titrow  col-md-3 col-sm-3 col-xs-3">Mail
							<span title="Obligatoire">*</span></span>
						<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					...
					<div class="col-sm-6 col-md-6 col-xs-12">
						<span class="titrow  col-md-3 col-sm-3 col-xs-3">Nom et
							prénom <span title="Obligatoire">*</span></span>
						<span class="tabInput col-md-9 col-sm-9 col-xs-9">
							<input type=text name='cli_nom'
								tabindex=<?= $tabindex++ ?> size="50"
								maxlength="100" required
								onkeyup="setStartSaisie(true);"
								onblur='searchByName(this.value)'
								list='listVendeurName' />
		...
		<div class="col-sm-6 col-xs-12">
			...
			<fieldset class=fiche style='display:none' id="fieldSetAcheteur">
				<legend class="titreFiche link"
					onclick='goTo("client.php","consult",document.ficheForm.ach_id.value,"")'>
					L'acheteur
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12">
						<span class="titrow  col-md-3 col-sm-3 col-xs-3">Nom et
							prénom <span title="Obligatoire">*</span></span>
						<span class="tabInput col-md-9 col-sm-9 col-xs-9">
							<input type=text name='ach_nom'
								tabindex=<?= $tabindex++ ?> size="50"
								maxlength="100" onkeyup="setStartSaisie(true);"
								onblur='searchAchByName(this.value)'
								list='listAcheteurName' />
	...
	<div class="row fiche">
		<div class="col-sm-3 col-md-3 col-xs-6 btnAction" id="tdBtnAction">
			...
			<button name="buttonValideFiche" tabindex=<?= $tabindex++ ?>
				disabled>Enregistrer
			</button>
		</div>
		<div class="col-sm-3 col-md-3 col-xs-6 btnAction" style='display:none'
			id="tdBtnPdf">
			<input type=button value="Impression Fiche" onclick="imprimeFiche()"
				name="buttonPDFFiche" tabindex=<?= $tabindex++ ?>>
		</div>
		<div class="col-sm-3 col-md-3 col-xs-6 btnAction" style='display:none'
			id="tdBtnSup">
			<input type=button value="Supprimer" name="buttonSupprimeFiche"
				onclick="supprimerFiche()" tabindex=<?= $tabindex++ ?> />
		</div>
		<div class="col-sm-3 col-md-3 col-xs-6 btnAction" style='display:none'
			id="tdBtnEmel">
			<input type=button value="Emel confirme"
				name="buttonEmelConfirmFiche"
				onclick="x_action_reMelConfirme(this.form.obj_id.value,  display_retour_test)"
				tabindex=<?= $tabindex++ ?> />
			<input type=hidden name="obj_etat_new" value="CONFIRME" />
			<input type=button value="Confirme" name="buttonConfirmFiche"
				onclick="confirmeFiche()" tabindex=<?= $tabindex++ ?> />
		</div>

		<div class="col-sm-3 col-md-3 col-xs-6 btnAction">
			<input type=button value="Annuler" onclick="fermerCRUD()"
				tabindex=<?= $tabindex++ ?>>
		</div>
	</div>
</form>