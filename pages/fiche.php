	...
	<fieldset class=fiche>
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-xs-12">
				...
				<span class="tabInput col-md-9 col-sm-9 col-xs-9">
					<input type=text name="obj_modele" size=30 maxlength="50" tabindex=<?= $tabindex++ ?> style="text-transform:uppercase" list="listModeles" placeholder="Nom du vélo" onkeyup="setStartSaisie(true);" />
			...
			<div class="col-sm-6 col-md-6 col-xs-12">
				...
				<span class="tabInput col-md-10 col-sm-10 col-xs-9">
					<textarea rows="4" cols="100" tabindex=<?= $tabindex++ ?> style="resize:none;overflow: none;" name="obj_description" maxlength="200" onkeyup="MaxLengthTextarea(this, 200);" onkeyup="setStartSaisie(true)" placeholder="Année d'achat, prix d'achat, taille, accessoires, révision (transmission, pneus, freins..)">Taille :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prix d'achat : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Année d'achat : (etc...)</textarea>
				</span>
