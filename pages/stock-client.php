...
<div class='row alert alert-info'>
	...
	<div class='col-md-8 col-sm-8 col-xs-12 maskMobile'>
		<input type=radio name="range"
	...
	<div class='col-md-8 col-sm-8 col-xs-12 onMobile'>
		<input type=radio name="range"
			onclick="searchRange(0,100)" ;>
		< 100&euro;
			<input type=radio name="range"
	...
	<div class='col-md-8 col-sm-8 col-xs-8'>
		Critères : <input type=text class="autocomplete" name='search_<?= rand(1, 100) ?>' size="10" maxlength="100" onkeyup="search(this.value)" style='width:60%'
			id=searchAll
			placeholder="Recherche avec plusieurs mots possible." />
		<img src='Images/b_drop.png' height="15px" onclick='getElement("searchAll").value="";search()' />
	</div>
