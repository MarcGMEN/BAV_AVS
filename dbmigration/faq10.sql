INSERT INTO `bav_actu`(`act_titre`, `act_text`, `act_numero_bav`, `act_type`, `act_active`, `act_date`, `act_mail`) 
VALUES
...
('Comment savoir si mon vélo est vendu ?','Sur place, par téléphone ou en ligne via le numéro du vélo, mise à jour instantanée.',2025,'FAQ',1,'2025-11-01 12:12:12','avs.vtt@mgail.com'),
('Peut-on modifier le prix du vélo ?','Oui, en venant sur place et en demandant au staff.',2025,'FAQ',1,'2025-11-01 12:12:12','avs.vtt@mgail.com'),
('Quand récupérer un vélo non vendu ?','Le dimanche jusqu’à 18h. Une autre personne peut venir avec le coupon dépôt.',2025,'FAQ',1,'2025-11-01 12:12:12','avs.vtt@mgail.com'),
('Y a-t-il de l’aide pour estimer ou choisir un vélo ?','Oui, desc bénévoles conseillent vendeurs et acheteurs.',2025,'FAQ',1,'2025-11-01 12:12:12','avs.vtt@mgail.com');
