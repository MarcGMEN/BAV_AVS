		...
		var sajax_asynchro = new Array();
				...
				sajax_asynchro['return_countClient']=1;
				...
				sajax_asynchro['return_count_fiches']=1;
				sajax_asynchro['return_num_max_fiches']=1;
		...
		// wrapper for return_countClient		
		function x_return_countClient() {
			sajax_do_call("return_countClient",
				x_return_countClient.arguments);
		}
		
				
		// wrapper for return_isClientByMel		
		function x_return_isClientByMel() {
			sajax_do_call("return_isClientByMel",
				x_return_isClientByMel.arguments);
		}
		
				
		// wrapper for connect_client		
		function x_connect_client() {
			sajax_do_call("connect_client",
				x_connect_client.arguments);
		}
		
				
		// wrapper for action_redonneCode		
		function x_action_redonneCode() {
			sajax_do_call("action_redonneCode",
				x_action_redonneCode.arguments);
		}
		...
		// wrapper for return_count_fiches		
		function x_return_count_fiches() {
			sajax_do_call("return_count_fiches",
				x_return_count_fiches.arguments);
		}
		
				
		// wrapper for return_num_max_fiches		
		function x_return_num_max_fiches() {
			sajax_do_call("return_num_max_fiches",
				x_return_num_max_fiches.arguments);
		}
